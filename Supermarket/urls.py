...
urlpatterns = [
    ...
    path('product-delete/<int:product_id>/',
         delete_product, name='product-delete'),
    ...
    path('customer-detail/<int:pk>/',
         customer_detail_view, name='customer-detail'),
    path('customer-edit/<int:pk>/', customer_edit, name='customer-edit'),
    path('supplier-detail/<int:pk>/',
         supplier_detail_view, name='supplier-detail'),
    path('supplier-edit/<int:pk>/', supplier_edit, name='supplier-edit'),


    path('category-list/', category_list_view, name='category-list'),
    path('category-list/<int:pk>/delete/',
         delete_category_list_view, name='category-delete'),

    path('type-list/', type_list_view, name='type-list'),
    path('type-list/<int:pk>/delete/',
         delete_type_list_view, name='type-delete'),
    ...
    path('delete-sale-from-list/<int:pk>/',
         delete_sales_from_list, name='delete_sales_from_list'),
    ...
    path('delete-purchase/<int:pk>/',
         delete_procurement_list, name='delete-purchase'),

    path('transaction-history/', transaction_list, name='transaction'),

    path('edit-category/<int:pk>/', edit_category_view,
         name='edit_category_view'),
    path('edit-type/<int:pk>/', edit_type_view, name='edit_type_view'),
    path('delete_expired_stock/<int:id>/',
         delete_expired_stock, name='delete_expired_stock'),
    ...
    path("invoice/<int:pk>/", invoice_details, name="invoice-details"),
    path("invoice/delete/<int:pk>/", delete_invoice, name="delete-invoice"),



    path("receipt/", sales_receipt, name="sales_receipt"),
